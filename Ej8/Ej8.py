...
# Función precio de Bitcoin en diferentes monedas
...
# Funcion tipo de cambio de PEN desde SUNAT
...
# Precio bitcoin en diferentes monedas
precio_bitcoin = obtener_precio_bitcoin()

if precio_bitcoin is not None:
    # Tipo de cambio PEN desde Sunat
